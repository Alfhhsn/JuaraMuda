...
<html lang="en">
  ...
  <body>
  <?php echo $__env->make('navbarabout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="container Logo text-center">
        ...
        <div class="card border border-0 mt-5 mb-4" style="background-color: #AF4A61; border-radius: 25px;">
          <div class="card-body mt-2 mb-2">
            <h4 class="Penjelasan" style ="font-family: 'Poppins', Sans-serif; src: url(https://fonts.google.com/specimen/Montserrat?query=Montserrat); color: #FBFCFC;">JuaraMuda adalah produk di segmen pendidikan yang memberikan manfaat dan kemudahan untuk memperoleh informasi seputar beasiswa dan lomba bagi mahasiswa yang mengalami masalah dalam biaya pendidikan dan bagi mahasiswa yang ingin meningkatkan prestasi dan pengalaman melalui keikutsertaan di berbagai lomba
                                                                                                                                                                        Berbeda dengan produk kompetitor, produk kami menyediakan informasi yang aktual, akurat, dan terpercaya mengenai beasiswa dan lomba baik yang diselenggarakan oleh instansi maupun universitas</h4>
            <h4 class="Penjelasan" style ="font-family: 'Poppins', Sans-serif; src: url(https://fonts.google.com/specimen/Montserrat?query=Montserrat); color: #FBFCFC;">JuaraMuda dikembangkan untuk membantu Mahasiswa dalam menemukan informasi beasiswa dan lomba dengan cepat, mudah, dan akurat
                                                                                                                                                                        Kami yakin, kami sudah berhasil jika sudah melihat jumlah pengguna JuaraMuda yang mendaftar beasiswa dan lomba dari informasi yang kami sediakan meningkat secara signifikan pada 1 tahun kedepan</h4>                                                                                                                                                                        
          </div>
        </div>
    </div>  
...
</html><?php /**PATH C:\application\JuaraMuda\resources\views/about.blade.php ENDPATH**/ ?>